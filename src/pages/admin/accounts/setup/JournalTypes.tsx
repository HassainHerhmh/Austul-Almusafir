    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-2">
          ...
          <button onClick={loadData} className="acc-btn acc-btn-primary px-4 py-2 rounded">
            🔄 تحديث
          </button>

          <button onClick={() => window.print()} className="acc-btn acc-btn-secondary px-4 py-2 rounded">
            🖨️ طباعة
          </button>
        </div>
      ...
      <div className="acc-table-wrap">
        <table className="acc-table text-center">
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={r.id} className={i % 2 === 0 ? "" : "acc-row-alt"}>
                ...
                <td className="border px-3 py-2">{r.branch_name || DEFAULT_BRANCH_NAME}</td>
      ...
      {showModal && (
        <div className="fixed inset-0 acc-modal-overlay flex items-center justify-center z-50">
          <div className="acc-modal-panel p-6 rounded w-[420px] space-y-2">
            ...
            <div className="flex justify-between pt-2">
              ...
              <button onClick={save} className="acc-btn acc-btn-primary px-4 py-2 rounded">حفظ</button>
            </div>
          </div>
        </div>
      )}
