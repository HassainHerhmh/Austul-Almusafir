    ...
    <div className="driver-track-page">
      ...
      <div className="driver-track-card">
        <p className="driver-track-note">
          افتح هذه الصفحة من متصفح الجوال، اسمح بالموقع، وابدأ التتبع. أبقِ التبويب مفتوحاً ولا تغلق الشاشة إن
          أمكن. هذا أكثر استقراراً من تطبيق التتبع على أجهزة سامسونج.
        </p>
